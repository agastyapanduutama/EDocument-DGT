...
/* statussuratfrm.html */
class __TwigTemplate_78d63646d6b85f50f4cdc380197d9190 extends Twig_Template
{
...
<table width=\"100%\" border=\"0\">
  <tr>
    <td width=\"9%\">Kode Status</td>
    <td width=\"1%\">:</td>
    <td width=\"90%\"><input name=\"kode_status\" type=\"text\" id=\"kode_status\" class=\"required\" size=\"10\">
    *
  ...
  <tr>
    <td>Nama Jenis</td>
    <td>:</td>
    <td><input name=\"nama_status\" type=\"text\" id=\"nama_status\" class=\"required\" size=\"40\">
      * </td>
  </tr>
  <tr>
...
<table border=\"0\">
  <tr>
    ...
    <td><select name=\"berd\" id=\"berd\">
      <option value=\"a.kode_status\">Kode Satatus</option>
      <option value=\"a.nama_status\">Nama Status</option>
...
\t\turl: '";
        ...
        echo "index.php/statussurat/viewdata',
\t\tdatatype: \"json\",
\t\tmtype : \"post\",
\t\t
...
\t\t\t{name:'kode_status',index:'kode_status', width:90},
\t\t\t{name:'nama_status',index:'nama_status', width:170},
...
\t\t\tjQuery(\"#kode_status\").val(jQuery(\"#ListData\").getCell(rowid,'kode_status'));
\t\t\tjQuery(\"#nama_status\").val(jQuery(\"#ListData\").getCell(rowid,'nama_status'));
...
\tjQuery(\"#ListData\").setGridParam({url:'";
        ...
        if (isset($context["base_url"])) { $_base_url_ = $context["base_url"]; } else { $_base_url_ = null; }
        echo twig_escape_filter($this->env, $_base_url_, "html", null, true);
        echo "index.php/statussurat/finddata/'+by+'/'+key});
...
\tjQuery.post(\"";
        ...
        if (isset($context["base_url"])) { $_base_url_ = $context["base_url"]; } else { $_base_url_ = null; }
        echo twig_escape_filter($this->env, $_base_url_, "html", null, true);
        echo "index.php/statussurat/delete_data\",{ id : data},
\tfunction(output){
