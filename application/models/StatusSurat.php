...
class StatusSurat
{
	...
	/**
	 * @Id
	 * @Column(name="id_status", type="integer", nullable=false)
	 * @GeneratedValue(strategy="AUTO")
	 */	
	private $id; 	 
	
	/**
	 * @Column(name="kode_status", type="string", length=20, unique=true, nullable=false)
	 */
	private $kode_status;	 
	
	/**
	 * @Column(name="nama_status", type="string", length=100, unique=true, nullable=true)
	 */
	private $nama_status;	 
    ...
    public function setKodeStatus($kode_status)
	{
	...
	public function getKodeStatus() { return $this->kode_status; }
   	public function getNamaStatus() {  return $this->nama_status; }
