...
/* jenissurveyfrm.html */
class __TwigTemplate_b7016dc630ecbf1d60112ca2c974dacf extends Twig_Template
{
...
\t\turl: '";
        ...
        echo "index.php/jenissurvey/viewdata',
\t\tdatatype: \"json\",
\t\tmtype : \"post\",
\t\t
...
\tjQuery(\"#ListData\").setGridParam({url:'";
        ...
        if (isset($context["base_url"])) { $_base_url_ = $context["base_url"]; } else { $_base_url_ = null; }
        echo twig_escape_filter($this->env, $_base_url_, "html", null, true);
        echo "index.php/jenissurvey/finddata/'+by+'/'+key});
...
\tjQuery.post(\"";
        ...
        if (isset($context["base_url"])) { $_base_url_ = $context["base_url"]; } else { $_base_url_ = null; }
        echo twig_escape_filter($this->env, $_base_url_, "html", null, true);
        echo "index.php/jenissurvey/delete_data\",{ id : data},
\tfunction(output){
