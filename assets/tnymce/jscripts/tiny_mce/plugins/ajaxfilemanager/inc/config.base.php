...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	// $_SERVER['SERVER_NAME']
	//$_SERVER['HTTP_HOST']
	//define('CONFIG_SYS_MY_DOCROOT', "http://localhost/depotrek/panel/library");
	//echo CONFIG_SYS_MY_DOCROOT;
	...
	//define('CONFIG_SYS_DEFAULT_PATH', CONFIG_SYS_MY_DOCROOT.'/mce/uploaded/'); //accept relative path only
	//define('CONFIG_SYS_ROOT_PATH', CONFIG_SYS_MY_DOCROOT.'/mce/uploaded/');   //accept relative path only
