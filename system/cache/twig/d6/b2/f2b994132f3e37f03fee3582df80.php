...
/* sifatsuratfrm.html */
class __TwigTemplate_d6b2f2b994132f3e37f03fee3582df80 extends Twig_Template
{
...
<div class=\"title\">Sifat Surat</div>
<form action=\"\" method=\"post\" name=\"form1\" id=\"form1\">
<table width=\"100%\" border=\"0\">
  <tr>
    <td width=\"9%\">Kode Sifat</td>
    <td width=\"1%\">:</td>
    <td width=\"90%\"><input name=\"kode_sifat\" type=\"text\" id=\"kode_sifat\" class=\"required\" size=\"10\">
    *
  ...
  <tr>
    <td>Nama Jenis</td>
    <td>:</td>
    <td><input name=\"nama_sifat\" type=\"text\" id=\"nama_sifat\" class=\"required\" size=\"40\">
      * </td>
  </tr>
  <tr>
...
<table border=\"0\">
  <tr>
    ...
    <td><select name=\"berd\" id=\"berd\">
      <option value=\"a.kode_sifat\">Kode Sifat</option>
      <option value=\"a.nama_sifat\">Nama Sifat</option>
...
\t\turl: '";
        ...
        echo "index.php/sifatsurat/viewdata',
\t\tdatatype: \"json\",
\t\tmtype : \"post\",
\t\t
...
\t\t\t{name:'kode_sifat',index:'kode_sifat', width:90},
\t\t\t{name:'nama_sifat',index:'nama_sifat', width:170},
...
\t\t\tjQuery(\"#kode_sifat\").val(jQuery(\"#ListData\").getCell(rowid,'kode_sifat'));
\t\t\tjQuery(\"#nama_sifat\").val(jQuery(\"#ListData\").getCell(rowid,'nama_sifat'));
...
\tjQuery(\"#ListData\").setGridParam({url:'";
        ...
        if (isset($context["base_url"])) { $_base_url_ = $context["base_url"]; } else { $_base_url_ = null; }
        echo twig_escape_filter($this->env, $_base_url_, "html", null, true);
        echo "index.php/sifatsurat/finddata/'+by+'/'+key});
...
\tjQuery.post(\"";
        ...
        if (isset($context["base_url"])) { $_base_url_ = $context["base_url"]; } else { $_base_url_ = null; }
        echo twig_escape_filter($this->env, $_base_url_, "html", null, true);
        echo "index.php/sifatsurat/delete_data\",{ id : data},
\tfunction(output){
