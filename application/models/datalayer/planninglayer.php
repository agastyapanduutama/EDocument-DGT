<?php
class planninglayer extends CI_Model {
	...
	public function listDetail($id)
	{
		/*
		$query = $this->db->query("
			SELECT a.*, b.pekerjaan, c.kode_project, d.nama_jenissurvey 
		...
		*/
		$query = $this->db->query("
			...
			JOIN trans_wilayah c ON a.id_project=c.id_project
			JOIN mst_jenissurvey d ON d.id_jenissurvey=c.id_survey
			LEFT JOIN trans_planning e on a.id_project=e.id_project AND a.id_pekerjaan=e.id_pekerjaan AND a.id_detail=e.id_detail
			WHERE a.id_project = $id
			ORDER BY c.kode_project, b.id_pekerjaan, a.id_detail
		");
