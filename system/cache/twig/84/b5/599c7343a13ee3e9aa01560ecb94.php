...
/* linkfrm.html */
class __TwigTemplate_84b5599c7343a13ee3e9aa01560ecb94 extends Twig_Template
{
...
\t\turl: '";
        ...
        echo "index.php/linkmaster/viewdata',
\t\tdatatype: \"json\",
\t\tmtype : \"post\",
\t\t
...
\tjQuery(\"#ListData\").setGridParam({url:'";
        ...
        if (isset($context["base_url"])) { $_base_url_ = $context["base_url"]; } else { $_base_url_ = null; }
        echo twig_escape_filter($this->env, $_base_url_, "html", null, true);
        echo "index.php/linkmaster/finddata/'+by+'/'+key});
...
\tjQuery.post(\"";
        ...
        if (isset($context["base_url"])) { $_base_url_ = $context["base_url"]; } else { $_base_url_ = null; }
        echo twig_escape_filter($this->env, $_base_url_, "html", null, true);
        echo "index.php/linkmaster/delete_data\",{ id : data},
\tfunction(output){
...
";
    ...
    {
        return array (  168 => 129,  160 => 125,  149 => 118,  99 => 72,  29 => 4,  26 => 3,);
    }
}
