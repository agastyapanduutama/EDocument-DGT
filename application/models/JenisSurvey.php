...
/**
 * @Entity
 * @Table(name="mst_jenissurvey")
 */
class JenisSurvey
{
	/**
	 * @Id
	 * @Column(name="id_jenissurvey", type="integer", nullable=false)
	...
	/**
	 * @Column(name="kode_jenissurvey", type="string", nullable=false)
	 */	
	private $kode_jenis;
	...
	/**
	 * @Column(name="nama_jenissurvey", type="string")
	 */	
	private $nama_jenis;
