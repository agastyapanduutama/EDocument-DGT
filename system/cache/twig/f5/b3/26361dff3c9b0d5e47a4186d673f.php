...
/* dokumenlogrpt.html */
class __TwigTemplate_f5b326361dff3c9b0d5e47a4186d673f extends Twig_Template
{
    ...
    {
        // line 4
        echo "<div class=\"title\">daftar dokumenlog</div>
<fieldset>
...
\t\thref: \"";
        ...
        if (isset($context["base_url"])) { $_base_url_ = $context["base_url"]; } else { $_base_url_ = null; }
        echo twig_escape_filter($this->env, $_base_url_, "html", null, true);
        echo "index.php/report/detailog/\"+id
\t});
};
</script>
";
    ...
    {
        return array (  151 => 96,  138 => 87,  133 => 86,  128 => 85,  122 => 83,  113 => 78,  102 => 71,  58 => 31,  29 => 4,  26 => 3,);
    }
}
