 ...
 */
class Subgroup extends \models\Subgroup implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setKodeSubgroup($kode_subgroup);
    }

    public function setNamaSubgroup($nama_subgroup)
    {
        $this->__load();
        return parent::setNamaSubgroup($nama_subgroup);
    }
    ...
    {
        $this->__load();
        return parent::getKodeSubgroup();
    }

    public function getNamaSubgroup()
    {
        $this->__load();
        return parent::getNamaSubgroup();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'kode_subgroup', 'nama_subgroup', 'keterangan', 'add_date', 'modified_date', 'add_user', 'modified_user');
    }
