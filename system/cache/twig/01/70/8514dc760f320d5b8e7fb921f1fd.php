...
/* jenissuratfrm.html */
class __TwigTemplate_01708514dc760f320d5b8e7fb921f1fd extends Twig_Template
{
...
<table width=\"100%\" border=\"0\">
  <tr>
    <td width=\"9%\">Kode Jenis</td>
    <td width=\"1%\">:</td>
    <td width=\"90%\"><input name=\"kode_jenis\" type=\"text\" id=\"kode_jenis\" class=\"required\" size=\"10\">
    *
  ...
  <tr>
    <td>Nama Jenis</td>
    <td>:</td>
    <td><input name=\"nama_jenis\" type=\"text\" id=\"nama_jenis\" class=\"required\" size=\"40\">
      * </td>
  </tr>
  <tr>
...
<table border=\"0\">
  <tr>
    ...
    <td><select name=\"berd\" id=\"berd\">
      <option value=\"a.kode_jenis\">Kode Jenis</option>
      <option value=\"a.nama_jenis\">Nama Jenis</option>
...
\t\turl: '";
        ...
        echo "index.php/jenissurat/viewdata',
\t\tdatatype: \"json\",
\t\tmtype : \"post\",
\t\t
...
\t\t\t{name:'kode_jenis',index:'kode_jenis', width:90},
\t\t\t{name:'nama_jenis',index:'nama_jenis', width:170},
...
\t\t\tjQuery(\"#kode_jenis\").val(jQuery(\"#ListData\").getCell(rowid,'kode_jenis'));
\t\t\tjQuery(\"#nama_jenis\").val(jQuery(\"#ListData\").getCell(rowid,'nama_jenis'));
...
\tjQuery(\"#ListData\").setGridParam({url:'";
        ...
        if (isset($context["base_url"])) { $_base_url_ = $context["base_url"]; } else { $_base_url_ = null; }
        echo twig_escape_filter($this->env, $_base_url_, "html", null, true);
        echo "index.php/jenissurat/finddata/'+by+'/'+key});
...
\tjQuery.post(\"";
        ...
        if (isset($context["base_url"])) { $_base_url_ = $context["base_url"]; } else { $_base_url_ = null; }
        echo twig_escape_filter($this->env, $_base_url_, "html", null, true);
        echo "index.php/jenissurat/delete_data\",{ id : data},
\tfunction(output){
